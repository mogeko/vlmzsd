...
Generated by the one-time bootstrap tool `tools/reference/dump_vectors.c`,
which links the C reference objects (`build/crypto.o`,
`build/crypto_internal.o`, `build/endian.o`) and prints byte-exact outputs:
